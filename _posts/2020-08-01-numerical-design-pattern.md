...
個人的には，代数系を始めとする純粋な数学的オブジェクトを扱えるライブラリもそうだが，多体系物理学でほぼデファクトスタンダードと化した対象を扱える高次ライブラリを作ることに興味を持っている．
...
もちろん既に[ALPS](http://alps.comp-phys.org/static/pydocs2.2/)のようなライブラリがあることは承知しているが，個人的にはモンスターパッケージを作らずにミニマムな設定でオブジェクト指向を貫きたいと思うわけである．
