...
\address{(+81)9017179903 \\ tarotene@iis.u-tokyo.ac.jp} % Your phone number and email

\begin{document}

\begin{rSection}{Objective}
Seeking the following working position where my experience on academic research effectively works.
\begin{itemize}
    \item Research Scientist, Software Engineer, Machine Learning Engineer
\end{itemize}

My academic specialty is theoretical/computational condensed-matter physics.
\end{rSection}
...
\item Assisted students to use lecture-room computers and do exercises
\end{rSubsection}
...
\begin{rSection}{Qualifications and Courseworks}

\begin{rSubsection}{Computational Science Alliance (Univ. Tokyo)}{April 2018 - Present}{}{}
...
\begin{rSubsection}{DSS: Education and Research for Domain-Knowledge Creation}{April 2019 - Present}{Graduate School of Information Science and Technology, Univ. Tokyo}{}
